...
if (isset($_POST['aceptar'])){
    ...
    foreach ($historicoReservas as $fila){
        ...
        $htmlTabla.= <<<FIN
        <tr>
            <th>$reservaID</th><td>$reservaInicio</td><td>$reservaFin</td><td>$reservaObservaciones</td><td>$servicio</td><td>$lineaWF</td><td>$reservaObservacionesFinalizacion</td>
        </tr>
FIN;
    }
}
        ...
        <div data-role="content">
            ...
            <fieldset data-role="controlgroup" data-type="vertical">
                ...
                <table data-role="table" id="table-column-toggle" class="ui-responsive table-stroke">
                    <thead>
                        <tr>
                            <th>ID reserva</th><<th>Inicio</th><th>Fin</th><th>Observaciones Cliente</th><th>Servicio</th><th>Línea WF</th><th>Observaciones Finalización</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php echo $htmlTabla ?>
